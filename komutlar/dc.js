...
exports.run = async (bot, message, args) => {
    ...
    var cesaret = ['İğrenç bir ses tonuyla şarkı söyle', 'Bugün yaptığın bir şeyle alakalı uydurma kısa, komik bir hikaye anlat', "Whatsapp'ındaki son mesajlaşmanı bize oku", 'Çok yüksek bir sesle 3 saniye bağır']
